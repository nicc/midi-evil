...
(deftest updates-device-state
  (is (= 
    ...
    (ds/update-notes {} [keydown-middle-c])))
  ...
  (is (= 
    ...
    (ds/update-notes { 60 { :attack 55 :note 60 } } [keydown-middle-d])))
  
  (is (= 
    { 62 { :attack 15 :note 62 } } 
    (ds/update-notes {} [keydown-middle-c keyup-middle-c keydown-middle-d]))))